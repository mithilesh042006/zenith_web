            ...
            <section className="py-20 px-6">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        ...
                        <a
                            href="/contact"
                            className="inline-block px-8 py-4 rounded-full bg-gradient-to-r from-highlight-red to-accent-orange text-white font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-highlight-red/30"
                        >
                            Register Now
                        </a>
                    </motion.div>
